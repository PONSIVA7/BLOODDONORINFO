    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group col-md-12">
                <form class="form-horizontal" method="post" action="donors.php">
            ...
            <?php if (isset($donors)): ?>
                <table class="table table-condensed">
                    ...
                    <tr>
                        ...
                        ?>" >
                            <td><?= $i; ?></td>
                            <td><?= $d['fname'] . " " . $d['mname'] . " " . $d['lname']; ?></a></td>
                            <td><?= $d['sex']; ?></td>
                            <td><?= wordwrap($d['address'], 20, "<br>"); ?></td>
                            <td><?= $d['city']; ?></td>
                            <td><?= $d['mobile']; ?></td>
                            <td><?= $d['dday']; ?></td>
                            <td><?= $d['lday']; ?></td>
                            <td><?= $d['reentry']; ?></td>
                            <td><?= $d['b_type']; ?></td>
                            <td><a href="donoredit.php?id=<?= $d['id']; ?>">Edit</a> || <a href="donordelete.php?id=<?= $d['id']; ?>">Delete</a></td>  
                        </tr>
                    <?php endforeach; ?>
                </table>
            <?php endif; ?>
